...
var loader;
var file_loaded_name;
var file_loaded = false;
var mesh;
var geometry,material;
(function () {
    
    var uploadfiles = document.querySelector('#image-file');
    ...
    function uploadFile(file){
        ...
        xhr.onreadystatechange = function() {
            if (xhr.readyState == 4 && xhr.status == 200) {
                ...
                console.log("loading file: "+"models/"+file.name);
        ...
        xhr.send(fd);
      console.log("going out upload file");
        file_loaded_name=file.name;
    }
}());
// function change()
// {
//     document.getElementById("submitButton").value="Thank you for order!"; 
// }
...
//                 loader.load("/home/cabox/upload/"+file.name);
      console.log("loader load model: " + 'models/' + file_loaded_name);
      loader.load('models/' + file_loaded_name);
...
//     container = document.getElementById('stl-viewer-div');
...
//             shininess: MAT_SHINE
//         });
//       var selectedObject = scene.getObjectByName("test_name");
//       if(selectedObject){
//         console.log("object for removal found");
//       }
...
//         mesh.name = "test_name";
        ...
        var price = parseInt(measure(d[0]))*0.3+parseInt(measure(d[1]))*0.5+parseInt(measure(d[2]))*0.1;
        info.innerHTML = file_loaded_name + 'is OK. Price: ' + price + ' ';
...
//     renderer.setSize(window.innerWidth, window.innerHeight);
  ...
  if(last_div === undefined){
    last_div = webgl_div.appendChild(renderer.domElement);
  }else{
    webgl_div.removeChild(last_div);
    last_div = webgl_div.appendChild(renderer.domElement);
  }
